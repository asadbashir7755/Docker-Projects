...
const UpdateForm = ({ visible, onCancel = () => {}, onUpdate }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Only include mediaFiles if explicitly changed by user
      if (mediaFilesChanged) {
        console.log("Including mediaFiles in request because they were changed");
        ...
        console.log("Excluding mediaFiles from request to keep original files");
      }
